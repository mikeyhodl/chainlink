...
// ErrorHandler takes an Apollo error and renders the error message. If it is an
// authentication error, it will clear the redux cache of the auth credentials
// and redirect back to the sign in page
//
// This is a temporary solution until we can move authentication away from using
// redux.
export const ErrorHandler: React.FC<Props> = ({ error }) => {
